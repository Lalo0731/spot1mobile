            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="/" class="logo respont-logo">
                        <img class="w-50 mt-n1 ms-3" src="{{asset('images/icono-while.svg')}}" alt="spot1mobile" class="img-logo">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
        ...
        <div class="col-lg-12">
          ...
          <div class="col-md-3 col-lg-4 pl-lg-5 mb-4 mb-md-0 col p-4 col-md-foot-3">
            ...
            <ul class="list-unstyled">
                ...
                <li><p class="text-white style-text w600"><i class="fa-solid fa-mobile p-2"></i>Teléfono: 800 000 0990 o +52 961 876 4758</p></li>
